...
public class connectionManager 
{
	...
	//String ServiceUrl="http://192.168.0.100/shopping_qr/Service1.svc";
	...
	public void GetProductDetails()
	{
		...
		try
		{
		    ...
		    if(statusLine.getStatusCode() == HttpStatus.SC_OK)
		    {
		        ...
		        fillProduct_Request.setDescription(Description);
		        fillProduct_Request.setLocation(Location);
		    }
		    else
		    {
    ...
    public void GetOffer()
    {
        ...
        try
        {
            ...
            final String TAG_img = "off_img";

            String url=String.format(ServiceUrl+"/getOffer");
            HttpClient httpclient = new DefaultHttpClient();
            HttpResponse response = httpclient.execute(new HttpGet(url));
            StatusLine statusLine = response.getStatusLine();
            if(statusLine.getStatusCode() == HttpStatus.SC_OK)
