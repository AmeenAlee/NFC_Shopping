...
public class Selection_ extends Activity {
    ...
    ImageView imgQr,imgCart,imgOffer,imgLogout,imgNfc;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        imgNfc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Selection_.this,NFC_Page.class));
            }
        });
    ...
    public Handler hd3 = new Handler() {
        public void handleMessage(Message msg) {
            ...
            switch (resp) {
                case 0:
                    Intent intent=new Intent(Selection_.this,OffersActivity.class);
                    startActivity(intent);
                    break;
                case 1:
