...
public class Product_Details_Page extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//Toast.makeText(getApplicationContext(),fillProduct_Request.GetProductName(),Toast.LENGTH_LONG).show();
		...
		txtLoc.setText(fillProduct_Request.getLocation());
		txtDesc.setText(fillProduct_Request.getDescription());
