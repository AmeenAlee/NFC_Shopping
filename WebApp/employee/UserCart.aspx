<%@ Page Title="" Language="C#" MasterPageFile="~/employee/MasterPage.master" AutoEventWireup="true" CodeFile="UserCart.aspx.cs" Inherits="employee_UserCart" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <div style="margin-left: 30px; margin-top: 40px; margin-bottom: 40px">
        <asp:GridView ID="GridView1" runat="server"  AutoGenerateColumns="False"  Width="1000px"
            ...
            BorderStyle="Solid" BorderWidth="1px" OnSelectedIndexChanged="GridView1_SelectedIndexChanged1" >
        ...
        <asp:Label ID="lblTotalCost" runat="server" Text=""></asp:Label>
                    ...
                    <div style="margin-left: 30px; margin-top: 40px; margin-bottom: 40px; text-align: center">
                            ...
                            <asp:RadioButton ID="RadioButton1" runat="server" Text="Delivery" checked="true" GroupName="type"/>
                      
                      
                           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:RadioButton ID="RadioButton2" runat="server" Text="Pick Up" GroupName="type" />
