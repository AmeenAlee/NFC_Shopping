...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="content-wrapper">
          ...
          <div class="row">
              ...
              <div class="card card-statistics">
                <div class="card-body">
                  <div class="clearfix">
                    ...
                    <%--  <h4 class="bold-text"><%= countEmployee %></h4>--%>
                    </div>
                  </div>
                  <p class="text-muted">
                    <i class="fa fa-exclamation-circle mr-1" aria-hidden="true"></i><a href="Manage_Employees.aspx">view Details</a>
                  </p>
                </div>
              </div>
            </div>
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 mb-4">
              <div class="card card-statistics">
               ...
               <%--       <h4 class="bold-text"><%= countCustomer %></h4>--%>
                    </div>
                  </div>
                  <p class="text-muted">
                    <i class="fa fa-bookmark-o mr-1" aria-hidden="true"></i><a href="Manage_Customers.aspx">view Details</a>
                  </p>
                </div>
              </div>
            </div>
        ...
        <%--             <h4 class="bold-text"><%= countProduct %></h4>--%>
                    </div>
                  </div>
                  <p class="text-muted">
                    <i class="fa fa-calendar mr-1" aria-hidden="true"></i><a href="Manage_Products.aspx">view Details</a>
                  </p>
                </div>
              </div>
            </div>
              ...
              <div class="card card-statistics">
                <div class="card-body">
                  <div class="clearfix">
                    ...
                    <div class="float-right">
                      <p class="card-text text-dark">Sales_History</p>
                 <%--<h4 class="bold-text"><%= countplacecom %></h4>--%>
                    </div>
                  </div>
                  <p class="text-muted">
                    <i class="fa fa-repeat mr-1" aria-hidden="true"></i><a href="Sales_History.aspx">view Details</a>
                  </p>
                </div>
              </div>
            </div>
              ...
              <div class="card card-statistics">
                <div class="card-body">
                  <div class="clearfix">
                    <div class="float-left">
                      <h4 class="text-primary">
                      <img alt="" src="images/004-folder-1.png" />
                        <i class="fa fa-twitter highlight-icon" aria-hidden="true"></i>
                      </h4>
                    </div>
                    <div class="float-right">
                      <p class="card-text text-dark">Analysis</p>
                     <%-- <h4 class="bold-text"><%= countplacecom %></h4>--%>
                    </div>
                  </div>
                  <p class="text-muted">
                    <i class="fa fa-repeat mr-1" aria-hidden="true"></i><a href="Analysis.aspx">view Analysis</a>
                  </p>
                </div>
              </div>
            </div>
