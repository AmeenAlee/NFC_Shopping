...
public partial class admin_AddNewProduct : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["Action"] == "edit")
        {
            if (FileUpload1.HasFile)
            {
                ...
                conn.Close();
                Response.Redirect("~/admin/Manage_Products.aspx?msg=update");
        ...
        else
        {
            ...
            if (FileUpload1.HasFile)
            {
                ...
                Response.Redirect("~/admin/Manage_Products.aspx?msg=add");
            }
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("~/admin/Manage_Products.aspx?msg=delete");
    }

    protected void btnBack_Click(object sender, EventArgs e)
    {
        Response.Redirect("~/admin/Manage_Products.aspx");
    }
}