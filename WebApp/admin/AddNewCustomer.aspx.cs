...
public partial class admin_AddNewCustomer : System.Web.UI.Page
{
        ...
        else
        {
            ...
            if (Request.QueryString["Action"] == "edit")
            {
                ...
                else
                {
                    ...
                    conn.Close();
                    Response.Redirect("~/admin/Manage_Customers.aspx?msg=update");
                }
            }
            else
            {
                ...
                else
                {
                    ...
                    Response.Redirect("~/admin/Manage_Customers.aspx?msg=add");
                }
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("~/admin/Manage_Customers.aspx?msg=delete");
    }
    ...
    {
        Response.Redirect("~/admin/Manage_Customers.aspx");
    }
}